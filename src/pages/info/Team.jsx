import { Autocomplete, Box, Checkbox, FormControlLabel, FormGroup, Paper, TextField, Typography, useTheme } from "@mui/material";
...
</Box><Box  sx={{display:"flex",flexDirection:"row", gap:5}}>
<Box sx={{display:"flex",flexDirection:"row", gap:2,mt:2}}>
<Typography
                        variant="h5"
                        component="div"
